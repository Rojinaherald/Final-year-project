			...
			if ($result && mysqli_num_rows($result) > 0) {
				while ($row = mysqli_fetch_assoc($result)) {
					...
					try {
						...
						$mail->setFrom('theemaildelivery@gmail.com', 'Assessment Management System');
						$mail->addAddress($studentEmail);

						$mail->isHTML(true);
						$mail->Subject = 'New Assessment Added';
						$mail->Body = "Dear Student,<br><br>A new assessment titled <strong>$aname1</strong> has been added. Please check the system for more details.<br><br>Best regards,<br>Assessment Management System";
